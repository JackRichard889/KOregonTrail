...
object GameState {
    ...
    val registry: EnvironmentRegistry = EnvironmentRegistry().apply {
        ...
        add_landmark(Landmarks.Landmarks.KANSAS_RIVER, 6, Landmarks.Types.RIVER)
        add_landmark(Landmarks.Landmarks.FORT_KEARNEY, 13, Landmarks.Types.FORT)
        add_landmark(Landmarks.Landmarks.CHIMNEY_ROCK, 22, Landmarks.Types.TEXTURED, "me/jackrichard/oregontrail/scenes/assets/location/chimney_rock.png")
        add_landmark(Landmarks.Landmarks.FORT_LARAMIE, 30, Landmarks.Types.FORT)
        add_landmark(Landmarks.Landmarks.INDEPENDENCE_ROCK, 37, Landmarks.Types.FORT)
        add_landmark(Landmarks.Landmarks.SOUTH_PASS, 44, Landmarks.Types.FORT)
        add_landmark(Landmarks.Landmarks.SODA_SPRINGS, 52, Landmarks.Types.RIVER)
        add_landmark(Landmarks.Landmarks.FORT_BRIDGER, 62, Landmarks.Types.FORT)
        add_landmark(Landmarks.Landmarks.FORT_HALL, 71, Landmarks.Types.RIVER)
        add_landmark(Landmarks.Landmarks.FORT_BOISE, 83, Landmarks.Types.FORT)
        add_landmark(Landmarks.Landmarks.BLUE_MOUNTAINS, 92, Landmarks.Types.RIVER)
        add_landmark(Landmarks.Landmarks.FORT_WALLA_WALLA, 100, Landmarks.Types.FORT)
        add_landmark(Landmarks.Landmarks.THE_DALLES, 112, Landmarks.Types.RIVER)
    }
